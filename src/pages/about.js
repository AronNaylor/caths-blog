    ...
    <Layout>
      ...
      <Row>
        <Col xs={{ span: 4, offset: 1 }}>
          <Img fluid={imgArr[0]} alt={"About page photo 1"}/>
        </Col>
      ...
      <Row style={{ paddingTop: "25px" }}>
        <Col xs={12} md={{ span: 10, offset: 1 }}>
          <p>
            ...
            school pen and paper. As the pencil starts to fade in the diaries I've kept hold of for nearly a decade
            (eeek) I thought I'd better transfer it online, however I have some serious catching up to do.
          </p>
        </Col>
      </Row>
      <Row>
        <Col xs={12} md={{ span: 10, offset: 1 }}>
          <p>At <b>27</b>, I have visited <b>27</b> countries.</p>
        </Col>
      </Row>
      <Row>
        <Col xs={12} md={{ span: 10, offset: 1 }}>
